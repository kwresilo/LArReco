...
public:
    ...
    TH1F                   *m_hIsCorrectEventFractionMomentum;     ///< The isCorrectEventFraction vs target energy
    TH1F                   *m_hMomentumAll;
...
CosmicRayTargetHistogramCollection::CosmicRayTargetHistogramCollection() :
    m_hIsCorrectEventFractionMomentum(nullptr),
    m_hMomentumAll(nullptr),
